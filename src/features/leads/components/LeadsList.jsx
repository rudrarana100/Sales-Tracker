  ...
  if (!leads || leads.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-sm font-bold text-slate-900 dark:text-slate-100">No Leads Found</p>
        <p className="mt-1 text-xs text-slate-400">
          Try changing your search query or collection filter.
        </p>
      </div>
    );
  }
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2.5">
              <h3
                ...
                className="cursor-pointer text-xs font-bold text-slate-800 dark:text-slate-100 transition-colors hover:text-blue-600 dark:hover:text-blue-400 truncate"
              >
                {lead.lead_name}
              </h3>
              <span
            ...
            <div className="mt-1 flex items-center gap-4 text-[11px] text-slate-400">
              ...
              <span className="flex items-center gap-1.5 hidden sm:flex font-mono">
          ...
          <div className="flex items-center gap-1 ml-3 shrink-0">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="rounded-2xl border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">
                <AlertDialogHeader>
                  <AlertDialogTitle className="text-base font-bold">Delete Lead?</AlertDialogTitle>
                  <AlertDialogDescription className="text-xs text-slate-500 dark:text-slate-400">
                    This action cannot be undone. This will permanently delete
                    the lead and its associated interaction history.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    ...
                    className="bg-rose-600 text-white hover:bg-rose-500 rounded-xl text-xs font-bold shadow-xs cursor-pointer"
                  >
                    Delete
                  </AlertDialogAction>
                </AlertDialogFooter>
